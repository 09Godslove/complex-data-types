...
let spotsLeft = (ICUWard.room1.capacity + ICUWard.room2.capacity) - (3 + 1)
...
let distanceFromOrigin = ((Math.sqrt(solarSystem.properties.location.x**2 + solarSystem.properties.location.y**2 + solarSystem.properties.location.z**2)).toFixed(0)).toString()
